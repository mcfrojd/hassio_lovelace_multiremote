...
};const wt = window.loadCardHelpers ? window.loadCardHelpers() : void 0;console.info("%c DECLUTTERING-CARD \n%c   Version 0.4.2   ", "color: orange; font-weight: bold; background: black", "color: white; font-weight: bold; background: dimgray");let bt = class extends K {
  set hass(t) {
    ...
    return this._hass && this._card && this._config ? Y`<div id="root">${this._card}</div>` : Y``;
  }async _createCard(t) {
